...
#We flip and scale based only on ilisi_after, so the highest column gets 1 and the lowest gets 0.
#Alternately, we could use the scores (if normalized) to scale
